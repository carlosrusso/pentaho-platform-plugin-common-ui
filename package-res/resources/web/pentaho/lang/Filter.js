define([
  ...
  var AbstractFilter = Base.extend({
    ...
    contains: function (filter, dataTable) {
      var k, nRows = dataTable.getNumberOfRows();
      var filteredRows = [];
  ...
  return {
    ...
    Root: RootFilter,
    // factories
    isEqual: function (property, value) {
      return new IsEqual(property, value);
    },
    isIn: function (property, value) {
      return new IsIn(property, value);
    },
    union: union,
